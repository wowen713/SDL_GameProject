...
void GameObject::Obj_Init(const char* image, int f, int d, int x, int y, int frame_w, int frame_h, int w, int h){
...
int GameObject::get_y_pos(){
  return y_pos; //returns y position of object
}

int GameObject::get_x_pos(){
  return x_pos; //returns x position of object
}

void GameObject::set_y_pos(int y){
  y_pos = y;  //sets y position of the object
}
...
int GameObject::get_height(){
  return Obj_Height; //returns the height of the object
}

int GameObject::get_width(){
  return Obj_Width;  //returns the width of the object
}
